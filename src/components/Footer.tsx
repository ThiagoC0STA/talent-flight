  ...
  return (
    <footer className="bg-[#F3F7FA] border-t border-[#E5EAF1]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold text-[#011640]">
                TalentFlight
              </span>
            </Link>
        ...
        <div className="border-t border-[#E5EAF1] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-center md:text-left text-[#010D26] text-sm">
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            ...
            <a
              href="#"
              className="text-[#010D26] hover:text-[#0476D9] transition-colors"
              aria-label="LinkedIn"
            >
